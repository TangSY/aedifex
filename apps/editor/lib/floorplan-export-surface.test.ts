...
import { exportFloorplanPdf, type FloorplanExportScope } from '@aedifex/editor'

// Runtime smoke assertion for the package-entry re-export (plan U2 / issue
// #619): this test imports the whole @aedifex/editor barrel, so if the
...
// itself lives in @aedifex/editor's floorplan tests; here we only pin the
// public surface.
