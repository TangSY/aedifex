...
## Landing evidence
- Normal main merge produced 58 conflicts; each was reviewed and resolved explicitly, with no automatic side selection. Regenerated bun.lock equals the validated R2 lock.
- Before this documentation update, the entire merged tree matched R2 05104fdfc exactly.
