---
name: open-pr
description: Open a pull request on TangSY/aedifex using the repo's PR template. Use when the user asks to open/create a PR, push and PR, or ship a branch in the editor repo.
allowed-tools: Bash(git *) Bash(gh *) Read
---

Open a pull request against `TangSY/aedifex` from the current branch.
